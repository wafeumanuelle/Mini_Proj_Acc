...
CChildView::CChildView() : m_pSensor(NULL), nb_ech(0), m_zoom(2), m_acq(false)
{
...
void CChildView::OnStart()
{
  ...
  if (!m_acq){
    ...
    // On remet à zéro les tableaux et le compteur
    init_ech_a();

    //creation et demarrage d'un timer chaque 100 ms
