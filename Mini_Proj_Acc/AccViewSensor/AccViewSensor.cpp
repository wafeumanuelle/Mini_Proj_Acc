...
// AccViewSensor.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CAccViewSensorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAccViewSensorApp::OnAppAbout)
END_MESSAGE_MAP()


// construction CAccViewSensorApp

CAccViewSensorApp::CAccViewSensorApp()
{
...
// Seul et unique objet CAccViewSensorApp

CAccViewSensorApp theApp;


// initialisation de CAccViewSensorApp

BOOL CAccViewSensorApp::InitInstance()
{
...
// gestionnaires de messages pour CAccViewSensorApp
...
void CAccViewSensorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
