...
L'Assistant Application a créé cette application AccViewSensor pour
...
votre application AccViewSensor.

AccViewSensor.vcproj
...
AccViewSensor.h
    ...
    classe d'application CAccViewSensorApp.
...
res\Toolbar.bmp
    ...
    IDR_MAINFRAME TOOLBAR dans AccViewSensor.rc afin d'ajouter des 
...
StdAfx.h, StdAfx.cpp
    ...
    nommé AccViewSensor.pch et un fichier de types précompilé nommé 
    StdAfx.obj.
